...
EXPERIMENTS = [
    ...
    "configs/experiment/twr_backbone_lra_listops_think2.yaml",
    "configs/experiment/twr_backbone_lra_listops_think6.yaml",
    "configs/experiment/twr_backbone_lra_listops_queries2.yaml",
    "configs/experiment/twr_backbone_ruler_needle.yaml",
    "configs/experiment/twr_backbone_ruler_needle_think4.yaml",
    "configs/experiment/twr_backbone_ruler_needle_think8.yaml",
    "configs/experiment/twr_backbone_ruler_needle_queries4.yaml",
]
