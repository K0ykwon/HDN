...
EXPERIMENTS = [
    "configs/experiment/twr_backbone_ruler_needle_256.yaml",
    "configs/experiment/twr_backbone_ruler_needle.yaml",
    "configs/experiment/twr_backbone_ruler_needle_1024.yaml",
    "configs/experiment/transformer_ruler_needle_256.yaml",
    "configs/experiment/transformer_ruler_needle.yaml",
    "configs/experiment/transformer_ruler_needle_1024.yaml",
    "configs/experiment/mamba_ruler_needle_256.yaml",
    "configs/experiment/mamba_ruler_needle.yaml",
    "configs/experiment/mamba_ruler_needle_1024.yaml",
]
