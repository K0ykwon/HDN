...
EXPERIMENTS = [
    ...
    "configs/experiment/twr_backbone_lra_listops_stride1.yaml",
    "configs/experiment/twr_backbone_lra_listops_window6.yaml",
    "configs/experiment/twr_backbone_ruler_needle.yaml",
    "configs/experiment/twr_backbone_ruler_needle_stride1.yaml",
    "configs/experiment/twr_backbone_ruler_needle_window10.yaml",
]
